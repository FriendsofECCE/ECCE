...
////@begin PTDataFrameGUI content construction
    ...
    itemBoxSizer7->Add(itemPanel8, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 20);
    ...
    itemBoxSizer10->Add(p_atomicNumLabel, 0, wxALIGN_CENTER_VERTICAL|wxALL, 0);

    itemBoxSizer10->Add(40, 0, 1, wxALIGN_CENTER_VERTICAL|wxALL, 0);

    p_atomicWeightLabel = new ewxStaticText( itemPanel8, wxID_STATIC, _("-1"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer10->Add(p_atomicWeightLabel, 0, wxALIGN_CENTER_VERTICAL|wxALL, 0);

    itemBoxSizer9->Add(0, 10, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 0);

    p_atomicSymbolLabel = new ewxStaticText( itemPanel8, wxID_STATIC, _("-1"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer9->Add(p_atomicSymbolLabel, 0, wxALIGN_RIGHT|wxALL, 10);

    p_electronConfigLabel = new ewxStaticText( itemPanel8, wxID_STATIC, _("-1"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer9->Add(p_electronConfigLabel, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 0);

    p_elementNameLabel = new ewxStaticText( itemPanel8, wxID_STATIC, _("-1"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer9->Add(p_elementNameLabel, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5);

    p_electronAffinityLabel = new ewxStaticText( p_dataPanel, wxID_STATIC, _("-1"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer7->Add(p_electronAffinityLabel, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemBoxSizer24->Add(p_ref2Label, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5);
    ...
    itemFlexGridSizer29->Add(itemStaticText34, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 10);
    ...
    itemFlexGridSizer29->Add(itemStaticText38, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 10);
    ...
    itemBoxSizer28->Add(itemStaticLine42, 0, wxGROW|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer43->Add(p_covRadLabel, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxTOP|wxBOTTOM, 5);
    ...
    itemFlexGridSizer43->Add(itemStaticText50, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxRIGHT|wxTOP|wxBOTTOM, 5);

    p_defCovRadLabel = new ewxStaticText( p_preferencePanel, wxID_STATIC, _("(Default=-1)"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer43->Add(p_defCovRadLabel, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxTOP|wxBOTTOM, 5);

    p_vdwRadLabel = new ewxStaticText( p_preferencePanel, wxID_STATIC, _("van der Waals Radius"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer43->Add(p_vdwRadLabel, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxTOP|wxBOTTOM, 5);
    ...
    itemFlexGridSizer43->Add(itemStaticText54, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxRIGHT|wxTOP|wxBOTTOM, 5);

    p_defVdwRadLabel = new ewxStaticText( p_preferencePanel, wxID_STATIC, _("(Default=-1)"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer43->Add(p_defVdwRadLabel, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxTOP|wxBOTTOM, 5);

    p_bftLabel = new ewxStaticText( p_preferencePanel, wxID_STATIC, _("Bond Formation Tolerance"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer43->Add(p_bftLabel, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxTOP|wxBOTTOM, 5);
    ...
    itemFlexGridSizer43->Add(itemStaticText58, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxRIGHT|wxTOP|wxBOTTOM, 5);

    p_defBftLabel = new ewxStaticText( p_preferencePanel, wxID_STATIC, _("(Default=-1)"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer43->Add(p_defBftLabel, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxTOP|wxBOTTOM, 5);
    ...
    itemBoxSizer3->Add(itemBoxSizer64, 0, wxGROW|wxALL, 5);

    itemBoxSizer64->Add(0, 0, 1, wxGROW|wxALL, 0);

    ewxButton* itemButton66 = new ewxButton( itemPanel2, ID_PTDATA_CLOSE, _("Close"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer64->Add(itemButton66, 0, wxALIGN_CENTER_VERTICAL|wxALL, 0);

    itemBoxSizer64->Add(0, 0, 1, wxGROW|wxALL, 0);

    ewxButton* itemButton68 = new ewxButton( itemPanel2, ID_PTDATA_HELP, _("Help"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer64->Add(itemButton68, 0, wxALIGN_CENTER_VERTICAL|wxALL, 0);

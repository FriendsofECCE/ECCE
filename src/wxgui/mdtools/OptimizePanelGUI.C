...
////@begin OptimizePanelGUI content construction
    ...
    itemBoxSizer7->Add(itemStaticText11, 0, wxALIGN_CENTER_VERTICAL|wxALL, 3);
    ...
    itemBoxSizer7->Add(itemStaticText13, 0, wxALIGN_BOTTOM|wxALL, 3);
    ...
    itemBoxSizer14->Add(itemStaticText17, 0, wxALIGN_BOTTOM|wxALL, 3);
    ...
    itemBoxSizer18->Add(itemStaticText19, 0, wxALIGN_CENTER_VERTICAL|wxALL, 3);
    ...
    itemBoxSizer18->Add(itemStaticText21, 0, wxALIGN_BOTTOM|wxALL, 3);
    ...
    itemBoxSizer26->Add(itemStaticText30, 0, wxALIGN_CENTER_VERTICAL|wxALL, 3);
    ...
    itemBoxSizer26->Add(itemStaticText32, 0, wxALIGN_BOTTOM|wxALL, 3);
    ...
    itemBoxSizer33->Add(itemStaticText34, 0, wxALIGN_CENTER_VERTICAL|wxALL, 3);
    ...
    itemBoxSizer33->Add(itemStaticText36, 0, wxALIGN_BOTTOM|wxALL, 3);

...
////@begin WxMachineRegisterGUI content construction
    ...
    itemBoxSizer38->Add(itemStaticText39, 0, wxALIGN_CENTER_VERTICAL|wxALL, 3);
    ...
    itemBoxSizer43->Add(itemStaticText44, 0, wxALIGN_CENTER_VERTICAL|wxALL, 3);
    ...
    itemBoxSizer43->Add(itemStaticText46, 0, wxALIGN_CENTER_VERTICAL|wxALL, 3);
    ...
    itemFlexGridSizer50->Add(itemStaticText51, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 3);
    ...
    itemFlexGridSizer50->Add(itemStaticText54, 1, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 3);
    ...
    itemFlexGridSizer50->Add(itemStaticText57, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 3);
    ...
    itemFlexGridSizer50->Add(itemStaticText60, 1, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 3);
    ...
    itemFlexGridSizer50->Add(itemStaticText63, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL, 3);

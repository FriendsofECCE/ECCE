...
#else
	// STRIPES
	    (void)SO_GET_ANY_PART(this,"XRotator", SoDragger);
	    (void)SO_GET_ANY_PART(this,"YRotator", SoDragger);
	    (void)SO_GET_ANY_PART(this,"ZRotator", SoDragger);

	// CENTER CHANGERS
	    (void)SO_GET_ANY_PART(this,"XCenterChanger", SoDragger);
	    (void)SO_GET_ANY_PART(this,"YCenterChanger", SoDragger);
	    (void)SO_GET_ANY_PART(this,"ZCenterChanger", SoDragger);
#endif

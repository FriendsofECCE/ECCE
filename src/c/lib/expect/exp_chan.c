...
#include "comm/tclInt.h"	/* Internal definitions for Tcl. */
...
#include "comm/exp_prog.h"
#include "comm/exp_command.h"
#include "comm/exp_log.h"
#include "comm/exp_event.h"
#include "comm/tcldbg.h" /* Dbg_StdinMode */
...
Tcl_ChannelType expChannelType = {
    "exp",				/* Type name. */
    (Tcl_ChannelTypeVersion)ExpBlockModeProc,	/* Set blocking/nonblocking mode.*/
    ...
    ClientData *handlePtr;	/* Where to store the handle.  */
{
	...
	*handlePtr = (ClientData)(long)esPtr->fdin;
    }

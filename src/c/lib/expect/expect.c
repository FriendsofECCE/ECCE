...
#include "comm/exp_tstamp.h"	/* this should disappear when interact */
			/* loses ref's to it */
#ifdef TCL_DEBUGGER
#include "comm/tcldbg.h"
#endif

#include "retoglob.inc" /* RE 2 GLOB translator C variant */

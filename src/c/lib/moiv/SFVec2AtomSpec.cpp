...
#include "inv/ChemKit/SFVec2AtomSpec.hpp"
...
SO_SFIELD_REQUIRED_SOURCE(SFVec2AtomSpec);
...
//
// Description:
//    Sets value from a SbVec2AtomSpec.
//
// Use: public

void
SFVec2AtomSpec::setValue(const SbVec2AtomSpec &atomSpec)
//
////////////////////////////////////////////////////////////////////////
{
    ChemBaseData *chemData;
...
//
// Description:
//    Sets value from 2 separate SbAtomSpecs. (Convenience function)
//
// Use: public

void
SFVec2AtomSpec::setValue(const SbAtomSpec &i,
    const SbAtomSpec &j)  // The 2 SbAtomSpecs
//
////////////////////////////////////////////////////////////////////////
{
...
//
// Description:
//    Sets value from array of 2 SbAtomSpecs. (Convenience function)
//
// Use: public

void
SFVec2AtomSpec::setValue(const SbAtomSpec ij[2])         // Array of values
//
////////////////////////////////////////////////////////////////////////
{
    ChemBaseData *chemData = NULL;
    ...
    ij[0].getValue(chemData, chemDisplay, theAtom);
    setVal(0, chemData, chemDisplay, theAtom);

    ij[1].getValue(chemData, chemDisplay, theAtom);
    setVal(1, chemData, chemDisplay, theAtom);
...
int  
SFVec2AtomSpec::operator ==(const SFVec2AtomSpec &atomSpec) const
//
////////////////////////////////////////////////////////////////////////
{   
...
void
SFVec2AtomSpec::setVal(short index, ChemBaseData *chemData,
...
SbBool
SFVec2AtomSpec::readValue(SoInput *in)
//
////////////////////////////////////////////////////////////////////////
{
...
SbBool
SFVec2AtomSpec::readAtomSpec(short index, SoInput *in)
//
////////////////////////////////////////////////////////////////////////
{
    SoBase *base;
...
void
SFVec2AtomSpec::countWriteRefs(SoOutput *out) const
// 
////////////////////////////////////////////////////////////////////////
{
...
void
SFVec2AtomSpec::writeValue(SoOutput *out) const
//
////////////////////////////////////////////////////////////////////////
{
    writeAtomSpec(0, out);
...
void
SFVec2AtomSpec::writeAtomSpec(short index, SoOutput *out) const
//
////////////////////////////////////////////////////////////////////////
{
    ChemBaseData *chemData = NULL;
...
void
SFVec2AtomSpec::fixCopy(SbBool copyConnections)
// 
////////////////////////////////////////////////////////////////////////
{
    ChemBaseData *chemData;
...
SbBool
SFVec2AtomSpec::referencesCopy() const
//
////////////////////////////////////////////////////////////////////////
{

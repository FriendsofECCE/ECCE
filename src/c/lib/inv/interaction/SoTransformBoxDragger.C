...
SoTransformBoxDragger::SoTransformBoxDragger()
{
    ...
    (void)SO_GET_ANY_PART( this,"scaler", SoScaleUniformDragger );
...
#else
    (void)SO_GET_ANY_PART( this, "rotator1", SoRotateCylindricalDragger);
    (void)SO_GET_ANY_PART( this, "rotator2", SoRotateCylindricalDragger);
    (void)SO_GET_ANY_PART( this, "rotator3", SoRotateCylindricalDragger);

    (void)SO_GET_ANY_PART( this, "translator1", SoTranslate2Dragger);
    (void)SO_GET_ANY_PART( this, "translator2", SoTranslate2Dragger);
    (void)SO_GET_ANY_PART( this, "translator3", SoTranslate2Dragger);
    (void)SO_GET_ANY_PART( this, "translator4", SoTranslate2Dragger);
    (void)SO_GET_ANY_PART( this, "translator5", SoTranslate2Dragger);
    (void)SO_GET_ANY_PART( this, "translator6", SoTranslate2Dragger);
#endif

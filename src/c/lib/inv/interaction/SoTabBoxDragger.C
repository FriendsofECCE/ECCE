...
#else
    (void)SO_GET_ANY_PART( this, "tabPlane1", SoTabPlaneDragger);
    (void)SO_GET_ANY_PART( this, "tabPlane2", SoTabPlaneDragger);
    (void)SO_GET_ANY_PART( this, "tabPlane3", SoTabPlaneDragger);
    (void)SO_GET_ANY_PART( this, "tabPlane4", SoTabPlaneDragger);
    (void)SO_GET_ANY_PART( this, "tabPlane5", SoTabPlaneDragger);
    (void)SO_GET_ANY_PART( this, "tabPlane6", SoTabPlaneDragger);
#endif

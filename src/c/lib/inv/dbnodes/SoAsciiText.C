...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (outlines[(int)c] == NULL) {
	FLoutline *flo = flGetOutline(fontId, VALIDATE_CHAR((GLuint)c));
	if (flo == NULL) {
	    outlines[(int)c] = MyFontOutline::getNullOutline();
	} else {
	    outlines[(int)c] = new MyFontOutline(flo, fontSize);
	    flFreeOutline(flo);
	}
    }
    return outlines[(int)c];
}
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (frontFlags[(int)c] == TRUE) return TRUE;

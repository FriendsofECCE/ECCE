...
class Ged98RunTypeFrame(EcceFrame):
    def __init__(self, parent, title, app, helpURL=""):
        EcceFrame.__init__(self, parent, title)
        panel = Ged98RunTypePanel(self, helpURL)
        self.Finalize()

class Ged98RunTypePanel(EccePanel):
...
frame = Ged98RunTypeFrame(None,
                          title = "ECCE Gaussian-98 Editor: Runtype Details",
                          app = app,
                          helpURL = "")

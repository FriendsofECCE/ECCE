...
#ifndef _EWX_DOCKART_H_
#define _EWX_DOCKART_H_
...
// this is the default art provider for ewxAuiManager.  Dock art
// can be customized by creating a class derived from this one,
// or replacing this class entirely

class ewxAuiDefaultDockArt : public ewxAuiDockArt
{
public:
